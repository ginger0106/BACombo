...
declare -a k_vals=( "30 8 5 0.5 1549775083" "10 8 5 0.5 1549775860" "3 8 5 0.5 1549780473" )
...
function get_k_data() {
	...
	pushd data/sent140/
		rm -rf meta/ data/
		./preprocess.sh --sf 0.3 -k ${keep_clients} -s iid -t sample --spltseed ${split_seed}
	popd
}
